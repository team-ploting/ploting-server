...
public enum JwtErrorCode implements BaseErrorCode {
    ...
    INVALID_TOKEN_FORMAT(400, "토큰 형식이 올바르지 않습니다.", HttpStatus.BAD_REQUEST),
    UNSUPPORTED_TOKEN(400, "지원되지 않는 토큰입니다.", HttpStatus.BAD_REQUEST),
    INVALID_TOKEN_ARGUMENT(400, "잘못된 토큰 정보가 포함되었습니다.", HttpStatus.BAD_REQUEST),
    ...
    INVALID_TOKEN_SIGNATURE(401, "토큰 서명이 올바르지 않습니다.", HttpStatus.UNAUTHORIZED),
